...
render(siteHeaderElem, new SiteMenuComponent().getElement(), RenderPosition.BEFOREEND);
render(siteMainElem, new FilterComponent(filters).getElement(), RenderPosition.BEFOREEND);
